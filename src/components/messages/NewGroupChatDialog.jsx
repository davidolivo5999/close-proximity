...
export default function NewGroupChatDialog({ currentUser, onClose, onCreate }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/50">
      <div className="bg-background w-full max-w-lg rounded-t-3xl flex flex-col max-h-[85vh]">
        {/* Header */}
        ...
        {/* Pinned footer */}
        <div className="p-5 pt-4 shrink-0 safe-area-bottom border-t border-border/50">
          <Button
